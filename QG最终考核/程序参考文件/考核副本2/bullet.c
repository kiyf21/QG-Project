...
void Bullet_Shoot1(void)
{
    ...
    if(Plant_state1 == NOPL)
    {
        ...
        if(last_state1 != NOPL)
        {
            LCD12864_Show_ImageBullet1(IMG_DATA_Empty, bullet_pos1);
...
//		}
		...
		{
			LCD12864_Show_ImageBullet1(Two_Bullet, bullet_pos1);
			Set_Plot_State(Position_Bullet_1+bullet_pos1,BULLET);//将当前地址写为子弹
		}
		else
		{
			LCD12864_Show_ImageBullet1(One_Bullet, bullet_pos1);
