...
void Bullet_Shoot2(void)
{
    ...
    if(delay_noblock(1,300))
    {
        ...
        if(Plant_state2 == PLPL)
		{
			...
			Set_Plot_State(Position_Bullet_2+bullet_pos2,BULLET);
		}
        else
		{
...
void Bullet_Shoot3(void)
{
    ...
    if(delay_noblock(2,300))
    {
        ...
        if(Plant_state3 == PLPL)
		{
			...
			Set_Plot_State(Position_Bullet_3+bullet_pos3,BULLET);
		}
        else
		{
